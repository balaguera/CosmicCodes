...
////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////
# include "../include/BiasFunctions.hpp"
using namespace std;
////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////
real_prec MASS_BIAS_FUNCTIONS::mass_function(real_prec nu, real_prec z, void *p){
  ...
  vector<gsl_real> A_par(10,0);
  vector<gsl_real> a_par(10,0);
  vector<gsl_real> b_par(10,0);
  vector<gsl_real> c_par(10,0);
  vector<gsl_real> D(10,0);
  D[0]=0;
  D[1]=log10(200);
  D[2]=log10(300);
  D[3]=log10(400);
...
real_prec MASS_BIAS_FUNCTIONS::dm_h_bias(real_prec z, real_prec nu, void *s_p){
  ...
  else if(mb=="Mo_White")ans= 1.+(0.75*nu-1)/(deltac); 
  else if(mb=="Sheth_Tormen")
  {
    a=0.707;
  ...
  else if(mb=="Tinker") //https://arxiv.org/pdf/1001.3162.pdf
  {
    y=log10(dcontrast); 
