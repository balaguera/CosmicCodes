 ...
 * @returns
 */
void Cholesky_decomposition(vector< vector<gsl_real> > &, vector< vector<gsl_real> > &);
////////////////////////////////////////////////////////////////////////////
/**
 * @brief
 * @returns
...
////////////////////////////////////////////////////////////////////////////
/**
 * @brief Index in the mesh (c+ ordering) for any dimension.
 * @returns
 */
ULONG index_nd(const std::vector<ULONG>& idx,
               const std::vector<ULONG>& dims);
////////////////////////////////////////////////////////////////////////////
/**
...
////////////////////////////////////////////////////////////////////////////
  /**
   * @brief  Number of pixels contained in a ring labled with ir. with 0<ir< 4nside-1 rings
   */
