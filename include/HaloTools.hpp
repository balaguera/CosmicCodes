 ...
 * @class<HaloTools>
 * @ingroup classes
 * @brief This class contain methods aimed at performing different analysis on a input halo catalog.
 * @file HaloTools.h
...
//////////////////////////////////////////////////////////
   ...
   *  @brief
   */
  real_prec min_redshift;
  //////////////////////////////////////////////////////////
  /**
   *  @brief
   */
  real_prec max_redshift;
  //////////////////////////////////////////////////////////
  /**
   *  @brief
   */
  real_prec min_redshift_cl;
  //////////////////////////////////////////////////////////
  /**
   *  @brief
   */
  real_prec max_redshift_cl;
  //////////////////////////////////////////////////////////
  /**
   *  @brief
   */
   ...
   *  @brief
   */
  ULONG ngals_in_zbin_from_map;
  //////////////////////////////////////////////////////////
  /**
   *  @brief
   */
  ULONG weighted_ngals_in_zbin;
  //////////////////////////////////////////////////////////
  /**
   *  @brief
   */
   ...
   * @brief 
   */
  real_prec mid_redshift;
  //////////////////////////////////////////////////////////
  /*
   * @brief 
   */
  real_prec bar_redshift;
  //////////////////////////////////////////////////////////
...
public:
   ...
   */
  HaloTools(Params &_params, Catalogue & _cat):params (_params), catalogue(_cat)
    {
    ...
    this->perform_extra_taks_on_tracers(); // This method completes some information of the tracers.
   ...
   * - Mach number, subject to the condition `true==Params._Get_cell_local_mach_number()`. In this case, mach number is assigned to each tracer by invoking the method `HaloTools.get_local_mach_number()`
   ...
   * - Tracer mass field (mass-weighted number counts on the mesh), subject to the condition `true==Params._Get_tracer_mass_field()` and provided that `Params._i_mass_g()>0 && this->params._i_mass_g()<HaloTools.NCOLS`.
   * - Tracer vmax field (vmax-weighted number counts on the mesh), subject to the condition `true==Params._Get_tracer_vmax_field()` and provided that `Params._i_vmax_g()>0 && this->params._i_vmax_g()<HaloTools.NCOLS`.
   * - Tracer spin field (spin-weighted number counts on the mesh), subject to the condition `true==Params._Get_tracer_spin_field()` and provided that `Params._i_spin_g()>0 && Params._i_spin_g()<HaloTools.NCOLS`.
   ...
   * @code 
      ...
      HaloTools htools(params, catalogue);
      htools.analyze_cat(true);
      So.message_time(start_all);
   * @endcode
   * @warning 
   * -Check the function while development: there are calculations commented, expecting orders from parameter file.
   ...
   *  @brief
   */
  void get_zbins_same_ngal(int nbins, real_prec zmn, real_prec zmx, vector<vector<real_prec> >&zzv);

  //////////////////////////////////////////////////////////
  /**
   *  @brief Converts the catalaog into a Healpix Map with number counts
   *  @param: Healpix map to be filled
   *  @param: data. If true, this method is used for galaxy map; if false, htis method is used to random map and shot noise calculations.
  */
  void Cat2Map(Healpix_Map<healpix_real>& map,  bool data);
  //////////////////////////////////////////////////////////
  /**
   * @brief  Get the map from the HaloToolsCl,epressed in terms of deltas
   */
  void Cat2Map_delta(char, Healpix_Map<real_prec>&);
  //////////////////////////////////////////////////////////
  /**
  ...
  //////////////////////////////////////////////////////////
  /**
   * @brief  Structure of vectors, containing the catalog. THis will replace the vector of structures approach.
   */
  Catalogue catalogue_aux;
  //////////////////////////////////////////////////////////
  /**
   * @brief  Structure of vectors, containing the catalog. THis will replace the vector of structures approach.
   */
  Catalogue catalogue_random;
  //////////////////////////////////////////////////////////
  /**
   * @brief  Structure of vectors, containing the catalog. 
   */
  Catalogue  catalogue_random_subsample;
  //////////////////////////////////////////////////////////
  /**
   * @brief  Structure of vectors, containing the catalog. 
   */
  Catalogue  catalogue_ranked;
  //////////////////////////////////////////////////////////
  /**
   * @brief  Structure of vectors, containing the catalog.
   */
  Catalogue  catalogue_central;
  //////////////////////////////////////////////////////////
  /**
   * @brief  Structure of vectors, containing the catalog. 
   */
  Catalogue catalogue_satellite;
  //////////////////////////////////////////////////////////
  /**1
   * @brief
   */
   ...
   * @brief
   */
  vector<gsl_real> MBmin; 
  ///////////////////////////////////////////////////////
  /**
   * @brief
   */
  vector<gsl_real> VMAXBmin;  
  ///////////////////////////////////////////////////////
  /**
   * @brief
   */
  vector<gsl_real> RSBmin;  
  ///////////////////////////////////////////////////////
  /**
   * @brief
   */
  vector<gsl_real> SPINBmin;  
  ///////////////////////////////////////////////////////
  /**
   * @brief
   */
  vector<gsl_real> DACHBmin;  
  ///////////////////////////////////////////////////////
  /**
   * @brief
   */
  vector<gsl_real> MACHBmin;  
  ///////////////////////////////////////////////////////
  /**
   * @brief
   */
  vector<gsl_real> LOCALDMBmin;  
  ///////////////////////////////////////////////////////
  /**
   * @brief
   */
  vector<gsl_real> DACHBmax;  
  ///////////////////////////////////////////////////////
  /**
   * @brief
   */
  vector<gsl_real> MACHBmax;  
  ///////////////////////////////////////////////////////
  /**
   * @brief
   */
  vector<gsl_real> LOCALDMBmax;  
  ///////////////////////////////////////////////////////
  /**
   * @brief
   */
  vector<gsl_real> CONCENTRATIONBmin;  
  //////////////////////////////////////////////////////////
  /**
   * @brief
   */
  ...
  //////////////////////////////////////////////////////////
  /**
   * @brief Container for tracer mach number
   */
  vector<real_prec>mach_number;
  //////////////////////////////////////////////////////////
  /**
   * @brief Container for dach (neighbour) number
   */
  vector<real_prec>dach_number;

  //////////////////////////////////////////////////////////
  /**
   * @brief  Number of colums read from input catalog
   */
  int NCOLS;
  //////////////////////////////////////////////////////////
  /**
   ...
   * @author ABA
   */
  void Get_Ranked_Props(Catalogue&,  string);
  //////////////////////////////////////////////////////////
  ...
  * @public
   * @brief Extra tasks
   * @details This method performs some extra tasks on the tracer catalogue allocated in Catalogue cat, suchas as assigning GridID, Helpix ID pixel, prepare bins in properties, 
   * and other taks done in the old Catalog::read_catalogue_new() method.
   */
  void perform_extra_taks_on_tracers();
  //////////////////////////////////////////////////////////
  /**
   ...
   */
  void assign_GridID_to_tracers(Catalogue & cat);
   ...
   */
  void assign_cwc_to_tracers(vector<WebType>&cwc);
  //////////////////////////////////////////////////////////
  /**
   * @brief Assign the information of the cosmic web classification in a given grid to the tracers accoring to their grid index
   * @param cwc is a vector over the mesh containing the cw classification
   * @param tr Set tro true if the field used to compute the CW is tracer dark matter, false for tracers 
   * @details Use this method to assign an integer to each tracer with the cwc encoded in the input container. The method assings the cwc to the ith tracer at the slot @code  Halo[i].cwt_gal @endcode using also the private structure @code box @endcode.
   */
  void assign_tidal_anisotropy_to_tracers(vector<real_prec>&tidal, bool tr);
  //////////////////////////////////////////////////////////
  /**
   ...
   * @result HaloToolsue with position in cartesian coordinates and mean number density
   ...
   * @return class member container \ref HaloTools::field_external" (or \ref HaloTools::field_external_marked). Notice that the output is not with _s (for redshift space), as we can select real or redshift space according to \ref REDSHIFT_SPACE_
   */
#ifdef  _USE_SEVERAL_RANDOM_FILES_
   ...
   * @param marked: bool, asking for weighting each tracer with a property
   * @param property: string, name of the property to use as weight. If non, "any" is enough.
   * @return class member container \ref HaloTools::field_external" (or \ref HaloTools::field_external_marked)
   */
   ...
   * @param marked: bool, asking for weighting each tracer with a property
   * @param property: string, name of the property to use as weight. If non, "any" is enough.
   * @return class member container \ref HaloTools::field_external" (or \ref HaloTools::field_external_marked) for real space, and \ref HaloTools::field_external_s" (or \ref HaloTools::field_external_marked_s) for redshift space.
   */
   ...
   * @brief THis method computes bias from individual asignment as a function of a property
   */
  void select_mark(std::vector<real_prec>&mark, string prop);
  //////////////////////////////////////////////////////////
  /**
   ...
   *  @brief
   */
  real_prec _min_MK(){return this->min_MK;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief
   */
  real_prec _max_MK(){return this->max_MK;}  
  //////////////////////////////////////////////////////////
  /**
   *  @brief
   */
  void set_min_MK(real_prec newr){this->min_MK;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief
   */
   void set_max_MK(real_prec newr){this->max_MK;}  
   ...
   *  @brief
   */
  void set_min_redshift(real_prec newr){this->min_redshift=newr;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief
   */
  void set_max_redshift(real_prec newr){this->max_redshift=newr;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief
   */
  real_prec _min_redshift(){return this->min_redshift;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief
   */
  real_prec _max_redshift(){return this->max_redshift;}
   ...
   *  @brief
   */
  real_prec _z_min(int i){return this->z_min[i];}
  //////////////////////////////////////////////////////////
  /**
   *  @brief
   */
  real_prec _z_max(int i){return this->z_max[i];}
  //////////////////////////////////////////////////////////
  /**
   *  @brief
   */
  void set_redshift_bin(int newiz){this->index_zbin=newiz;}
  ...
  //////////////////////////////////////////////////////////
  /**
   *  @brief  Container for the ndensity of photoz
   */
   ...
   *  @brief
   */
  ULONG _ngals_in_zbin(){return this->ngals_in_zbin;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief
   */
  ULONG _ngals_in_zbin_from_map(){return this->ngals_in_zbin_from_map;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief
   */
  ULONG _weighted_ngals_in_zbin(){return this->weighted_ngals_in_zbin;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief
   */
  ULONG _n_pixels(){return this->n_pixels;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief
   */
  ULONG _n_observed_pixels(){return this->n_observed_pixels;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief
   */
   ...
   *  @brief
   */
  real_prec _area_pixel(){return this->area_pixel;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief
   */
  real_prec _mean_number_galaxies_pix(){return this->mean_number_galaxies_pix;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief
   */
  real_prec _rms_ngal(){return this->rms_ngal;}
  //////////////////////////////////////////////////////////
  /**
   * @public
   * @brief
  */
  void set_rms_ngal(real_prec newrms){this->rms_ngal=newrms;}
