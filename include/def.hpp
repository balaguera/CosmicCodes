...
// ****************************************************************************************
/**
*@brief This directove prevents from multiple definitions of varibles introduced here as consexpr.
*/
# pragma once
// ****************************************************************************************
/**
...
*/
inline constexpr int  _NTHREADS_ = 14;

// ****************************************************************************************
inline constexpr int NEGATIVE_INT = -1;
inline constexpr int POSITIVE_INT = 1;
// ****************************************************************************************
/**
 * @brief Mock Mode
...
inline constexpr double factor_growth = 1.018018854;
#else
inline constexpr double factor_growth = 1.0;
#endif
// ****************************************************************************************
...
static constexpr real_prec DELTA_K = 0.01;
static constexpr real_prec MIN_K = 0.0;
#endif
// ****************************************************************************************
#if defined _ABACUS_ || defined (_MG_)
#define BIN_SHIFT static_cast<real_prec>(0.5) 
#else
static constexpr real_prec BIN_SHIFT = 0.0;
#endif
// **************************************************************************************
#define ULONG size_t
// ********************************************
...
*/
static constexpr int N_PROP_CAT = 10;
// ********************************************
static constexpr int MIN_N_PROP_CAT = 6;
// ********************************************
static constexpr double BIG_NUMBER = 1e7;
// ********************************************
inline constexpr double CFACTOR = M_PI/180.0 ;
// ********************************************
inline constexpr int NUM_ITER_MAP2ALM=0;

// ************************************************************************************************************************************
// ************************************************************CONSTANTS***************************************************************
// ************************************************************************************************************************************
// Define some constant factors
inline constexpr int REAL = 0;
inline constexpr int IMAG = 1;

inline constexpr int ONE = 1;
inline constexpr double dONE = 1.0;

inline constexpr ULONG KNOT_MAX_SIZE = 100000000;
inline constexpr ULONG V_MAX_SIZE = 100000000;

inline constexpr double LARGE_NUMBER = 1e20;
inline constexpr double MINUS_LARGE_NUMBER = -1e30;
inline constexpr int NOCELL = -2;
inline constexpr int NOVEL = -999;
...
// ************************************************************************************************************************************
/**
 * @brief Identifyers for cosmic-web environments
*/
enum class WebType : int {
    Full     = 0,
    Knot     = 1,
    Filament = 2,
    Sheet    = 3,
...
// ************************************************************************************************************************************
/**
 * @brief Identifyers for  mass assignment schemes
*/
enum class MassAssignment : int {
    NGP = 0,
    CIC = 1,
    TSC = 2,
    PCS = 3
...
// ************************************************************************************************************************************
/**
 * @brief Identifyers for system of coordinates
*/
...
// ************************************************************************************************************************************
/**
 * @brief Identifyers for Lines of sight
*/
enum class LineOfSight : int {
    X = 1,
    Y = 2,
    Z = 3
};
// ************************************************************************************************************************************
/**
 * @brief Identifyes poistion in structure cointainit min, max anxd mean of properties
*/
enum class PropStats : int {
    MIN = 0,
    MAX = 1,
    MEAN = 2
};
 ...
 * @brief 
*/
enum class MCMCactions : int {
    FREE = 0,               // Free parameter: varies according to proposal 
    FIXED  = 1,             // Fixed to input -fiducial- value
    GAUSSIAN_PRIOR  = 2     // Parameter varies with a Gaussian pdf with input width
};
// ************************************************************************************************************************************


// ********************************************
inline constexpr int NMIN_X_ONECELL = 0;
inline constexpr int NMIN_Y_ONECELL = 0;
// ********************************************
inline constexpr double num_1   = 1.0;
inline constexpr double num_0_5 = 0.5;
inline constexpr double itwo  = static_cast<double>(1.0)/static_cast<double>(2.0); 
// ********************************************
/**
 * @brief This number is used in the power spectrum to multiply the velocities and compute P(k) in redshift space, used in \ref FFTwfunctions.
*/
inline constexpr double VEL_BIAS_POWER = 1.0;
// ********************************************
/**
 * @brief Number of mdoes used to get an estimate of the average bias on large scales in \ref BiasMappingTechnique
*/
inline constexpr int N_MODES = 30;
// ********************************************
/**
 * @brief Initial mode index used to get an estimate of the average bias on large scales in \ref BiasMappingTechnique
*/
inline constexpr int N_MODE_INI = 1;
// ********************************************
/**
 * @brief Initial index (0..Nft) used to measure the residuals from INITIAL_MODE_RESIDUALS up to Nft/2 
*/
inline constexpr int INITIAL_MODE_RESIDUALS = 1;
// ********************************************
// Numbers used in the class measuring power spectrum
//#define CHUNK 27
/**
 * @brief For FFTW in 3 dimensions
*/
inline constexpr int ic_rank = 3;
// ********************************************
inline constexpr int ZERO = 0;
// ********************************************
inline constexpr int TOLERANCE_FACTOR = 10;
// ************************************************************************************************************************************
// ************************************************************FUNCTIONS***************************************************************
// ************************************************************************************************************************************
/**
...
*/
inline double myfabs(double x) {return x < 0.0 ? -x : x;}
// *************************************
/**
*@brief Bias model
*@return Bias model to pupulate DM density fields with overdensity x
*/
inline real_prec bias_test(real_prec x, real_prec alpha, real_prec rhoep, real_prec ep) {
    return std::pow(1.0 + x, alpha) * std::exp(-std::pow((1.0 + x) / rhoep, ep));
}
// *************************************
/**
*@brief |r|
...
*/
inline double _get_modulo(double x,double y,double z){return std::sqrt(x*x+y*y+z*z);}
// *************************************
/**
*@brief 100000|r|
*@return  modulus squared of vector with coordinates x, y, z multiplied by a large number
*/
inline constexpr real_prec _get_modulo_squared(real_prec x , real_prec y,real_prec z) {return 100000.0*(x*x+y*y+z*z) ;}
// *************************************
/**
*@brief |r|
*@return  modulus squared of vector with coordinates x, y, z
*/
inline constexpr real_prec _get_modulo_squared_n(real_prec x , real_prec y,real_prec z) {return x*x+y*y+z*z ;}
// ************************************************************************************************************************************
/**
...
*/
inline constexpr real_prec limit_mass_halos(real_prec x){ return 1.5e11*pow(x,1.1)+1.5e11*pow(x,2.8);}
// ************************************************************************************************************************************
/**
*@brief x sigma_v(Mv) for dark matter halos of the slics.
*@return  For a given x=M, halos cannot have sigma_v below this limit
*/
inline constexpr real_prec limit_vmax_halos(real_prec x) {return 7.02e-6 * std::pow(x, 0.405) + 1.1e-5 * std::pow(x, 0.415);}
// ************************************************************************************************************************************
...
//#define _ADD_NOISE_
#ifdef _ADD_NOISE_
inline constexpr real_prec MEAN_NEW = 1000.0;
#endif
// ************************************************************************************************************************************
// ************************************************************************************************************************************
// ************************************************************************************************************************************
...
inline constexpr real_prec NEWMAX_S2DELTA =  1.0;
inline constexpr real_prec NEWMIN_S2DELTA = -1.0;
#ifdef _USE_EXPONENT_S2DELTA_
inline constexpr real_prec EXPONENT_S2DELTA =
    static_cast<real_prec>(1.0 / 9.0);
#else
inline constexpr real_prec EXPONENT_S2DELTA = 1.0;
#endif
#endif
// ************************************************************************************************************************************
...
inline constexpr real_prec NEWMAX_S3 =  1.0;
inline constexpr real_prec NEWMIN_S3 = -1.0;
#ifdef _USE_EXPONENT_S3_
inline constexpr real_prec EXPONENT_S3 =
    static_cast<real_prec>(1.0 / 9.0);
#else
inline constexpr real_prec EXPONENT_S3 = 1.0;
#endif
#endif
// ***********************************************************************************************************************************
#endif
...
#endif
inline constexpr ULONG N_C_BIN1 = 4;
inline constexpr real_prec REDUCT_N_C_BIN1 = 4.0;
inline constexpr real_prec C1_MIN = -1.0;
inline constexpr real_prec C1_MAX =  1.0;
inline constexpr real_prec DELTA_C1 = (C1_MAX - C1_MIN) / static_cast<real_prec>(N_C_BIN1);
#else
inline constexpr ULONG N_C_BIN1 = 1;
inline constexpr real_prec C1_MIN = -200;
inline constexpr real_prec C1_MAX =  200;
inline constexpr real_prec DELTA_C1 = 1.0;
#endif
// ********************************************
#ifdef _USE_INVARIANT_TIDAL_FIELD_III_
inline constexpr ULONG N_C_BIN2 = 20;
inline constexpr real_prec REDUCT_N_C_BIN2 = 4.0;
inline constexpr real_prec C2_MIN = -1.0;
inline constexpr real_prec C2_MAX =  1.0;
inline constexpr real_prec DELTA_C2 =
    (C2_MAX - C2_MIN) /
    static_cast<real_prec>(N_C_BIN2);
#else
inline constexpr ULONG N_C_BIN2 = 1;
inline constexpr real_prec C2_MIN = -200;
inline constexpr real_prec C2_MAX =  200;
inline constexpr real_prec DELTA_C2 = 1.0;
#endif
// ********************************************
...
inline constexpr ULONG N_C_BIN3 = 10;
inline constexpr ULONG N_BINS_TA = 10;
inline constexpr real_prec C13MIN = -1;
inline constexpr real_prec C3_MAX =  1;
inline constexpr real_prec DELTA_C3 = (C3_MAX - C3_MIN) / N_C_BIN3;
#else
inline constexpr ULONG N_C_BIN3 = 1;
inline constexpr real_prec C3_MIN   = -40;
inline constexpr real_prec C3_MAX   =  40;
inline constexpr real_prec DELTA_C3 =  1.0;
#endif
...
inline constexpr ULONG N_CV_BIN1 = 20;
inline constexpr real_prec CV1_MIN = -40;
inline constexpr real_prec CV1_MAX =  40;
inline constexpr real_prec DELTA_CV1 = (CV1_MAX - CV1_MIN) / N_CV_BIN1;
#else
inline constexpr ULONG N_CV_BIN1 = 1;
inline constexpr real_prec CV1_MIN   = -40;
inline constexpr real_prec CV1_MAX   =  40;
inline constexpr real_prec DELTA_CV1 =  1.0;
#endif
// ********************************************
...
inline constexpr ULONG N_CV_BIN2 = 20;
inline constexpr real_prec CV2_MIN = -40;
inline constexpr real_prec CV2_MAX =  40;
inline constexpr real_prec DELTA_CV2 = (CV2_MAX - CV2_MIN) / N_CV_BIN2;
#else
inline constexpr ULONG N_CV_BIN2 = 1;
inline constexpr real_prec CV2_MIN   = -40;
inline constexpr real_prec CV2_MAX   =  40;
inline constexpr real_prec DELTA_CV2 =  1.0;
#endif

// ********************************************
#if defined (_USE_INVARIANT_SHEAR_VFIELD_III_) || defined (_USE_S3_) || defined (_USE_INVARIANT_PWEB_III_)
inline constexpr ULONG N_CV_BIN3 = 20;
inline constexpr real_prec CV3_MIN = -40;
inline constexpr real_prec CV3_MAX =  40;
inline constexpr real_prec DELTA_CV3 = (CV3_MAX - CV3_MIN) / N_CV_BIN3;
#else
inline constexpr ULONG N_CV_BIN3 = 1;
inline constexpr real_prec CV3_MIN   = -40;
inline constexpr real_prec CV3_MAX   =  40;
inline constexpr real_prec DELTA_CV3 =  1.0;
#endif
...
// ********************************************
/**
 * @brief Factor used in \Miscelanious to increase Nft resolution
*/
inline constexpr int _EXTRA_NFT_FACTOR_ = 2;
// ********************************************
#define LOGRO
///////////////////////////////////////////////
///////////////////////////////////////////////
...
inline constexpr real_prec cgs_Mpc = num_1;
inline constexpr real_prec cgs_sec = num_1;
inline constexpr real_prec cgs_km     = 0.3240779290e-19 * cgs_Mpc; // 1 km in 1 Mpc
inline constexpr real_prec cgs_clight = 0.9715611892e-14 * cgs_Mpc / cgs_sec;
inline constexpr real_prec eps     = 1.e-14;
#define _MESS_ So.message_screen("ABA", __LINE__);
#define _ACHTUNG_ So.message_warning("ACHTUNG in line ", __LINE__)
inline constexpr ULONG GAUSS_LEGANDERE_NODES_INTEGRATION = 500;
inline constexpr int   MAXIMUM_MULTIPOLE_POWER           = 1;
inline constexpr int   MAXIMUM_MULTIPOLE_WINDOW_MATRIX   = 5;
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
inline constexpr real_prec REDSHIFT_MIN = 0.0;
inline constexpr real_prec REDSHIFT_MAX = 5.0;
inline constexpr int       N_REDSHIFT_BINS = 1;
inline constexpr real_prec DELTA_Z =
    (REDSHIFT_MAX - REDSHIFT_MIN) /
    static_cast<real_prec>(N_REDSHIFT_BINS);
#endif
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
 * @brief  if this is defined a test chaning the Invariantes for input foriles from the hydro project is done
*/
#undef _HYDROTEST_
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/**
