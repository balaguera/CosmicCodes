...
class Cwclass {
 ...
 Cwclass(Params _par)
   ...
   */
  WebType get_Tclassification(ULONG i);
   ...
   */
  WebType get_Vclassification(int i);
  ...
  /**
   * @public
   * @brief Get tidal anisotropy using an density field in input binary, compute the CWC and write out
   * @param inp Input binary with density. This is important. This method converts to overdensity internally.
   * @param out Output binary filw with tidal anisotropy oin the mesh
   */
  void get_tidal_anisotropy(string inp, string out);

  /**
   * @public
   * @brief Get tidal anisotropy from input density_field and write into output binary file
   * @param den Input binary with density 
   * @param out Output binary filw with tidal anisotropy oin the mesh
   */
  ...
  /**
   * @public 
   * @brief  Get tidal anisotropy from input density_field 
   */
  void get_tidal_anisotropy(vector<real_prec>&delta);

  /**
   * @public 
   * @brief Get tidal anisotropy from vectir dens  and write into tidal
   * @param dens Input vector with density 
   * @param tidal Output vector  with tidal anisotropy oin the mesh
   */
