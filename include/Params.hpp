...
#include "NumericalMethods.hpp"  // def.h is included in the NumericalMethods.h file
...
{
    std::cout <<endl;
    print_field("Parameter name in json:", par_name);
    print_field("Loaded in section:", loading_sections);
    print_field("Parameter name in code:",      par_name_in_code);
    print_field("Description:",       description);
    print_field("Options:",           options);
    std::cout <<endl;
}
...
struct s_sections{
  bool Simulation;  
  bool DarkMatterCatalogue;  
  bool TracerCatalogue;  
  bool RandomCatalogue;  
  bool BiasAnalysis;
  bool CWCAnalysis;  
  bool FourierAnalysis;  
  bool SurveyProperties;  
  bool GalaxyAnalysis;  
  bool HaloAnalysis;  
  bool CorrelationFunction;
  bool AngularPowerSpectrum;
  bool FourierBessel;
  bool InitialConditions;
  bool CosmologicalLibrary;
  bool MCMC;
};
...
//////////////////////////////////////////////////////////
   ...
   */
  CoordinateSystem sys_of_coord_g;
  //////////////////////////////////////////////////////////
  /**
   ...
   * @details Read from input parameter file.
   **/
 CoordinateSystem sys_of_coord_dm;
  //////////////////////////////////////////////////////////
  ...
  //////////////////////////////////////////////////////////
  /**
   * @brief Minium absolute magnitude
   * @details Read from input parameter file.
   **/
  real_prec MKmin;
  //////////////////////////////////////////////////////////
  /**
   * @brief Minium abs magnitude
   * @details Read from input parameter file.
   **/
  real_prec MKmax;
  //////////////////////////////////////////////////////////
   ...
   * @details Read from input parameter file.
   */
  CoordinateSystem sys_of_coord_r;
  ...
  */
  ...
  //////////////////////////////////////////////////////////
  /**
   * @brief Direction along which redshift space distortions are to be applied in simulations, assuming plane parallel approximation.
   * @details 
   **/
  LineOfSight  direction_for_rsd_plane_parallel;
  //////////////////////////////////////////////////////////
  /**
  ...
  //////////////////////////////////////////////////////////
  /**
   * @brief Used for output of angular power spectrum in bins of multipole
   */
  string file_power_lbins;
  //////////////////////////////////////////////////////////
  /**
...
//////////////////////////////////////////////////////////
  /**
   * @brief Set true if semi_axis of halos are to be converted to ellipticity and prolatness
   */
  bool convert_to_halo_ellipiticity_and_prolatness;
 ...
 real_prec M_max_effective;
  ...
  ///////////////////////////////////////////////////////////
  /**
   * @brief  Type of estimator for angular clustering. K or J, both for Peebles estimators but J uses Jlm. K is the correct to use when the Wigner symbols represent the mixing matrix.
   */
  string type_of_angular_power_estimator;
  ///////////////////////////////////////////////////////////
  /**
   * @brief  Type of sky coverage (full, northern_hemisphere, southern_hemisphere)
   */
  string type_of_sky_coverage;

  ///////////////////////////////////////////////////////////
  /**
   * @brief  Choose the coordinate system between galactic and equatorial for angular clustering analysis. 
   * @details This is *ONLY* useful in case we split between south and north. If galactic, the code internaly selects north / south
    from the mask in input_file_mask (or input_file_mask_fs) but it demands an input mask *if we split in equatorialype of sky coverage (full, northern_hemisphere, southern_hemisphere)
   */
  string coordinate_system;

  ///////////////////////////////////////////////////////////
  /**
   * @brief Choose the hemisphere to compute clustering from. Here the codes sets to zero the rejected hemisfere (the inverse to that chosen here)
   */
  string define_hemisphere;
  ///////////////////////////////////////////////////////////
  /**
   * @brief Input file for angular mask
   */
  string input_file_mask;
  ///////////////////////////////////////////////////////////
  /**
   * @brief Input file for a second angular mask, for cross power
   */
  string input_file_mask2;
  ///////////////////////////////////////////////////////////
  /**
   * @brief Input file for angular mask
   */
  string input_file_mask_fullsky;
  ///////////////////////////////////////////////////////////
  /**
   * @brief Input file for angular mask
   */
  ...
  bool generate_fits_files;
    ///////////////////////////////////////////////////////////
  /**
   * @brief Resolution of the HealPix mask. If a mask is used, this is recomputed.
   */
  ULONG nside;
    ///////////////////////////////////////////////////////////
  /**
   * @brief Minimum multipole used for power spectrum measurement.
   */
  ULONG Lmin;
    ///////////////////////////////////////////////////////////
  /**
   * @brief Maximum multipole used for power spectrum measurement.
   * @details This constrained by the nside of the input mask (or the one defined in json parameter file). 
   */
  ULONG Lmax;

  ///////////////////////////////////////////////////////////
  /**
   * @brief Set the size of multipole bins for the output of binned estimates of power.
   */
  real_prec deltaL;
  ///////////////////////////////////////////////////////////
  /**
   * @brief Use the value of deltaL
   * @details Use this value to define, accoring to Lmin and Lmax, the number of multipole bins to output binned version of power spectrum.
   */
  bool use_deltaL;
  ///////////////////////////////////////////////////////////
  /**
  ...
  ///////////////////////////////////////////////////////////
  /**
   * @brief Width of the gaussian in redshift defining the bins for tomographic analysis and ARF
   */
  real_prec sigma_arf;
  ///////////////////////////////////////////////////////////
  /**
   * @brief Use random realizations to compute show-noise
   */
  bool shot_noise_correction_randomized;
  ///////////////////////////////////////////////////////////
  /**
   * @brief Number of random realizations to compute show-noise
   */
  ULONG N_random_shot_noise;
  ///////////////////////////////////////////////////////////
  /**
   * @brief Compute the mixing matrix Rll to convolve models of angular clustering
   */
   ...
   * @brief 
   */
  int n_z_bins_tomography;
  ///////////////////////////////////////////////////////////
  /**
   * @brief use_min_max_redshift_from_cat
   */
  bool use_min_max_redshift_from_cat;
  ///////////////////////////////////////////////////////////
  /**
   * @brief use_min_max_redshift_from_cat
   */
  bool use_min_max_redshift_from_nbar_file;
  ///////////////////////////////////////////////////////////
  /**
   * @brief Minimum redshift for tomographic analysis
   */
  real_prec min_redshift_tomography;
  ///////////////////////////////////////////////////////////
  /**
   * @brief Maximum redshift for tomographic analysis
   */
  real_prec max_redshift_tomography;
  ...
  ///////////////////////////////////////////////////////////
  /**
   * @brief Define whether the sample is volume limited (vls) or flux-limited (fls)
   */
  string type_of_sample;
  ///////////////////////////////////////////////////////////
  /**
   * @brief Type of opbserved rdshift
   */
  string type_of_redshift;
  ///////////////////////////////////////////////////////////
  /**
   * @brief Type of opbserved rdshift
   */
  ULONG Nbins_absMagnitude;
  ///////////////////////////////////////////////////////////
  /**
   * @brief use_min_max_redshift_from_cat
   */
  bool use_min_max_absMag_from_cat;
  ///////////////////////////////////////////////////////////
  /**
   * @brief 
   */
...
//------------------------------------------
   ...
   * @brief 
   */
  size_t  number_of_fit_parameters;
//------------------------------------------
  /** 
   * @brief 
   */
...
//------------------------------------------
   ...
   * @brief 
   */
  bool random_initial_value_within_priors;
//------------------------------------------
  /** 
   * @brief 
   */
...
//------------------------------------------
   ...
   * @brief 
   */
  size_t number_of_accepted_models;

//------------------------------------------
  /** 
   * @brief 
   */
  size_t number_of_burnin_phase_models;
//------------------------------------------
  /** 
   * @brief  Number of models accepted by the HM algorithm
   */
  size_t number_of_post_burnin_phase_models;
//------------------------------------------
  /** 
   * @brief  Number of models accepted by the HM algorithm
   */
  size_t number_of_avoided_steps_to_get_stats;
//------------------------------------------
  /** 
   * @brief  Number of models accepted by the HM algorithm
   */
  size_t number_of_steps_to_update_covariance;
//------------------------------------------
  /** 
   * @brief 
   */
...
//  Params(){}
   ...
   *  @return
   */
  size_t _N_dm_initial(){return this->N_dm_initial;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief Get the value of the private member
   *  @return
   */
  size_t _n_sknot_massbin(){return this-> n_sknot_massbin;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief Get the value of the private member
   *  @return
   */
  size_t _n_vknot_massbin(){return this-> n_vknot_massbin;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief Get the value of the private member
   *  @return
   */
  size_t _N_iterations_Kernel(){return this->N_iterations_Kernel;}
  //////////////////////////////////////////////////////////
  /** 
   ...
   */
  CoordinateSystem _sys_of_coord_g () const {return this->sys_of_coord_g;}
   ...
   */
  CoordinateSystem _sys_of_coord_dm () const  {return sys_of_coord_dm;}
   ...
   *  @return
   */
  bool _convert_to_halo_ellipiticity_and_prolatness () {return this->convert_to_halo_ellipiticity_and_prolatness;}
  void set_convert_to_halo_ellipiticity_and_prolatness (bool new_i_c) {this->convert_to_halo_ellipiticity_and_prolatness=new_i_c;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief 
   *  @return
 ...
 //////////////////////////////////////////////////////////
   ...
   *  @return new_los
   */
  LineOfSight _direction_for_rsd_plane_parallel() {return this->direction_for_rsd_plane_parallel;} 
 //////////////////////////////////////////////////////////
  /**
   *  @brief Get the value of the private member sys_of_coord_r
   *  @return sys_of_coord_r
   */
  CoordinateSystem _sys_of_coord_r () const {return this->sys_of_coord_r;}
   ...
   *  @return i_coord1_r
   */
  int _i_coord1_r () {return this->i_coord1_r;}
   ...
   *  @return i_coord2_r
   */
  int _i_coord2_r () {return this->i_coord2_r;}
   ...
   *  @return i_coord3_r
   */
  int _i_coord3_r () {return this->i_coord3_r;}
   ...
   *  @return mass_assignment_scheme
   */
  MassAssignment  _mass_assignment () const {return this->mass_assignment;}
  void set_mass_assignment_scheme (MassAssignment  new_mass_assignment_scheme) {this->mass_assignment=new_mass_assignment_scheme;}
  //////////////////////////////////////////////////////////
  /**
   ...
   *  @return file_power
   */
  string _file_power_lbins () {return this->file_power_lbins;}
  //////////////////////////////////////////////////////////
  /**
   ...
   *  @return input_file_mask
   */
  string _input_file_mask2(){return input_file_mask2;}
  //////////////////////////////////////////////////////////
  /**
...
//  Angular power spectrum parameters
   ...
   *  @brief Container to allocate the name of the enabled sections in the input json file. 
   */
  s_sections input_sections;

  //////////////////////////////////////////////////////////
  /**
   *  @brief type_of_angular_power_estimator
   */
  string _type_of_angular_power_estimator(){return this->type_of_angular_power_estimator;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief set type_of_angular_power_estimator
   */
  void set_type_of_angular_power_estimator(string nk){this->type_of_angular_power_estimator=nk;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief type_of_angular_power_estimator
   */
  string _type_of_sky_coverage(){return this->type_of_sky_coverage;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief set type_of_angular_power_estimator
   */
  void set_type_of_sky_coverage(string nk){this->type_of_sky_coverage=nk;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief type_of_angular_power_estimator
   */
  string _coordinate_system(){return this->coordinate_system;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief set coordinate_system
   */
  void set_coordinate_system(string nk){this->coordinate_system=nk;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief define_hemisphere
   */
  string _define_hemisphere(){return this->define_hemisphere;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief set coordinate_system
   */
  void set_define_hemisphere(string nk){this->define_hemisphere=nk;}

  //////////////////////////////////////////////////////////
  /**
   *  @brief define_hemisphere
   */
  string _input_file_mask_fullsky(){return this->input_file_mask_fullsky;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief set coordinate_system
   */
  void set_input_file_mas_fullskyk(string nk){this->input_file_mask_fullsky=nk;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief define_hemisphere
   */
  string _input_file_mask_north_equatorial(){return this->input_file_mask_north_equatorial;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief set coordinate_system
   */
  void set_input_file_mask_north_equatorial(string nk){this->input_file_mask_north_equatorial=nk;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief define_hemisphere
   */
  string _input_file_mask_south_equatorial(){return this->input_file_mask_south_equatorial;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief set coordinate_system
   */
  void set_input_file_mask_south_equatorial(string nk){this->input_file_mask_south_equatorial=nk;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief define_hemisphere
   */
  bool _generate_fits_files(){return this->generate_fits_files;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief set coordinate_system
   */
  void set_generate_fits_files(bool nk){this->generate_fits_files=nk;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief define_hemisphere
   */
  ULONG _Lmin(){return this->Lmin;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief set coordinate_system
   */
  void set_Lmin(ULONG nk){this->Lmin=nk;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief define_hemisphere
   */
  ULONG _Lmax(){return this->Lmax;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief set coordinate_system
   */
  void set_Lmax(ULONG nk){this->Lmax=nk;}

  //////////////////////////////////////////////////////////
  /**
   *  @brief define_hemisphere
   */
  ULONG _nside(){return this->nside;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief set coordinate_system
   */
  void set_nside(ULONG nk){this->nside=nk;}

  //////////////////////////////////////////////////////////
  /**
   *  @brief define_hemisphere
   */
  real_prec _deltaL(){return this->deltaL;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief set coordinate_system
   */
  void set_deltaL(real_prec nk){this->deltaL=nk;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief define_hemisphere
   */
  bool _use_deltaL(){return this->use_deltaL;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief set coordinate_system
   */
  void set_use_deltaL(bool nk){this->use_deltaL=nk;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief define_hemisphere
   */
  ULONG _N_L_bins(){return this->N_L_bins;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief set coordinate_system
   */
  void set_N_L_bins(real_prec nk){this->N_L_bins=nk;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief define_hemisphere
   */
  real_prec _sigma_arf(){return this->sigma_arf;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief set coordinate_system
   */
  void set_sigma_arf(real_prec nk){this->sigma_arf=nk;}

  //////////////////////////////////////////////////////////
  /**
   *  @brief define_hemisphere
   */
  bool _shot_noise_correction_randomized(){return this->shot_noise_correction_randomized;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief set coordinate_system
   */
  void set_shot_noise_correction_randomized(bool nk){this->shot_noise_correction_randomized=nk;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief define_hemisphere
   */
  ULONG _N_random_shot_noise(){return this->N_random_shot_noise;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief set coordinate_system
   */
  void set_N_random_shot_noise(ULONG nk){this->N_random_shot_noise=nk;}

  //////////////////////////////////////////////////////////
  /**
   *  @brief define_hemisphere
   */
  bool _compute_mixing_matrix(){return this->compute_mixing_matrix;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief set coordinate_system
   */
  void set_compute_mixing_matrix(bool nk){this->compute_mixing_matrix=nk;}

  //////////////////////////////////////////////////////////
  /**
   *  @brief define_hemisphere
   */
  int _n_z_bins_tomography(){return this->n_z_bins_tomography;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief set coordinate_system
   */
  void set_n_z_bins_tomography(int nk){this->n_z_bins_tomography=nk;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief 
   */
  bool _use_min_max_redshift_from_cat(){return this->use_min_max_redshift_from_cat;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief 
   */
  bool _use_min_max_redshift_from_nbar_file(){return this->use_min_max_redshift_from_nbar_file;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief set coordinate_system
   */
  void set_use_min_max_redshift_from_cat(bool nk){this->use_min_max_redshift_from_cat=nk;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief define_hemisphere
   */
  real_prec _min_redshift_tomography(){return this->min_redshift_tomography;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief set coordinate_system
   */
  void set_min_redshift_tomography(real_prec nk){this->min_redshift_tomography=nk;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief define_hemisphere
   */
  real_prec _max_redshift_tomography(){return this->max_redshift_tomography;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief set coordinate_system
   */
  void set_max_redshift_tomography(real_prec nk){this->max_redshift_tomography=nk;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief define_hemisphere
   */
  string _define_z_bins(){return this->define_z_bins;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief set coordinate_system
   */
  void set_define_z_bins(real_prec nk){this->define_z_bins=nk;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief define_hemisphere
   */
  string _type_of_sample(){return this->type_of_sample;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief set coordinate_system
   */
  void set_type_of_sample(string nk){this->type_of_sample=nk;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief define_hemisphere
   */
  string _type_of_redshift(){return this->type_of_redshift;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief set coordinate_system
   */
  void set_type_of_redshift(string nk){this->type_of_redshift=nk;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief define_hemisphere
   */
  ULONG _Nbins_absMagnitude(){return this->Nbins_absMagnitude;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief set coordinate_system
   */
  void set_Nbins_absMagnitude(ULONG nk){this->Nbins_absMagnitude=nk;}

  //////////////////////////////////////////////////////////
  /**
   *  @brief 
   */
  bool _use_min_max_absMag_from_cat(){return this->use_min_max_absMag_from_cat;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief set coordinate_system
   */
  void set_use_min_max_absMag_from_cat(bool nk){this->use_min_max_absMag_from_cat=nk;}

  //////////////////////////////////////////////////////////
  /**
   *  @brief 
   */
  bool _compute_jlm(){return this->compute_jlm;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief 
   */
  bool _mixing_matrix_exact(){return this->mixing_matrix_exact;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief set coordinate_system
   */
  void set_compute_jlm(bool nk){this->compute_jlm=nk;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief set coordinate_system
   */
  string _output_file_jlm(){return this->output_file_jlm;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief set coordinate_system
   */
  string _output_file_fits(){return this->output_file_fits;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief set coordinate_system
   */
  void set_output_file_jlm(string ss){this->output_file_jlm=ss;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief 
   */
  string _output_file_window(){return this->output_file_window;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief 
   */
  void set_output_file_window(string ss){this->output_file_window=ss;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief 
   */
  void set_output_file_power(string ss){this->file_power=ss;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief 
   */
  void set_output_file_power_bins(string ss){this->file_power_lbins=ss;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief 
   */
  string _input_mixing_matrix_lbins(){return this->input_mixing_matrix_lbins;}  
  //////////////////////////////////////////////////////////
  /**
   *  @brief 
   */
  string _input_mixing_matrix_l(){return this->input_mixing_matrix_lbins;}  
  //////////////////////////////////////////////////////////
  /**
   *  @brief 
   */
  string _harmonic_sampling(){return this->harmonic_sampling;}  

  //////////////////////////////////////////////////////////
  /**
   *  @brief Auxiliary container used to allocate output file names ot be plot in python
   */
  vector<string> output_files_hgaps;
  //////////////////////////////////////////////////////////
  /**
   *  @brief Auxiliary container used to allocate output file names ot be plot in python
   */
  vector<string> output_files_hgaps_maps;
  //////////////////////////////////////////////////////////
  /**
   *  @brief Auxiliary container used to allocate output file of mixing matrix for ang power
   */
  vector<string> output_files_mixing_matrix;
  //////////////////////////////////////////////////////////
  //////////////////////////////////////////////////////////
  //////////////////////////////////////////////////////////
  //////////////////////////////////////////////////////////
// MCMCM related params and containers
  //------------------------------------------
  /** 
   * @brief Container for the size of parameter steps (width of parameter prior)
   */
  std::vector<double>proposal_parameters;  
 //------------------------------------------
  /** 
   * @brief Container for the max value of parameters
   */
  std::vector<double>prior_parameters_max_values;  
 //------------------------------------------
  /** 
   * @brief Container for the min value of parameters
   */
  std::vector<double>prior_parameters_min_values;  
 //------------------------------------------
  /** 
   * @brief Container for the initial parameters; used in parameters are to be fixed
   */
  std::vector<double>initial_parameters;  
//------------------------------------------
  /** 
   * @brief Container indicating whether each parameter is fixed or varied within the MCMC
   * @details 0 means : vary; 1 means fixe it to the initial value, 2 means vary it around the initail value with a normal distributiuon using the width set in steps.
   */
  std::vector<int>action_parameters;
 
//------------------------------------------
  /** 
   * @brief 
   */
  std::vector<string>name_parameters;
   ...
   *  @brief 
   */
  size_t _number_of_chains(){return this->number_of_chains;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief 
   */
  size_t _number_of_accepted_models(){return this->number_of_accepted_models;}

  //////////////////////////////////////////////////////////
  /**
   *  @brief 
   */
  size_t _number_of_fit_parameters(){return this->number_of_fit_parameters;}
  //////////////////////////////////////////////////////////
  /**
   *  @brief 
   */
  size_t _number_of_burnin_phase_models(){return this->number_of_burnin_phase_models; }
  //////////////////////////////////////////////////////////
  /**
   *  @brief 
   */
  size_t _number_of_post_burnin_phase_models(){return this->number_of_post_burnin_phase_models; }
  //////////////////////////////////////////////////////////
  /**
   *  @brief 
   */
  size_t _number_of_avoided_steps_to_get_stats(){return this->number_of_avoided_steps_to_get_stats; }
  //////////////////////////////////////////////////////////
  /**
   *  @brief 
   */
  size_t _number_of_steps_to_update_covariance(){return this->number_of_steps_to_update_covariance; }

  //////////////////////////////////////////////////////////
  /**
   *  @brief 
   */
  bool _update_covariance(){return this->update_covariance; }
 ...
 /** 
   * @brief Retrieve private variable
  */
  bool _use_distance_priors(){return this->use_distance_priors;}
  //////////////////////////////////////////////////////////
 /** 
   * @brief 
  */
  int _dprior_ID(){return this->dprior_ID;}
  //////////////////////////////////////////////////////////
 /** 
   * @brief 
  */
  int _dprior_JD(){return this->dprior_JD;}
