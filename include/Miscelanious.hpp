 ...
 * @param Halo: structures of vectors type Catalogue with the coordinates
 ...
 * @author ABA
 */
void getDensity_NGP(s_params_box_mas *params, Catalogue &Halo, vector<real_prec>&delta, string weightmass);
//////////////////////////////////////////////////////////
/**
 * @brief Interpolation on a mesh using NGP
 ...
 * @author ABA
 */
void getDensity_CIC(s_params_box_mas *params, const Catalogue& Halo, vector<real_prec>&delta, string weightmass);
//////////////////////////////////////////////////////////
/**
 ...
 * @brief Interpolation on a mesh using TSC
 * @param params: structure of type s_params_box_mas
 * @param Halo: vector of structures of type Catalogue, with the coordinates
 * @details The size of the mesh is characterized by params.Nft The size of the volume is defined by params.Lbox.
 * @param weightmass: string denoting the property to use as weight.
 * @returns delta vector, \f$ \rho(\vec{x})\f$, interpolation of number counts field on a mesh.
 * @warning This function will be either deprecated or modified to implement grid_assignment_TSC
 * @author ABA
 */
void getDensity_TSC(s_params_box_mas *params, const Catalogue& Halo, vector<real_prec>&delta, string weightmass);
//////////////////////////////////////////////////////////
/**
 * @brief Interpolation on a mesh
 * @param params: structure of type s_params_box_mas
 * @param Halo:  structures of vecs type Catalogue, with the coordinates
 * @param weightmass: string denoting the property to use as weight.
 ...
 * @author ABA
 */
void MAS_NEW(s_params_box_mas *params, Catalogue &Halo, string weight, vector<real_prec> &delta);
////////////////////////////////////////////////////////////////////////////
/**
...
*/
void object_by_object_bias(Params, Catalogue&, vector<real_prec>&);
...
////////////////////////////////////////////////////////////////////////////
void print_catalog(Catalogue &Halo, string file, bool);
////////////////////////////////////////////////////////////////////////////
