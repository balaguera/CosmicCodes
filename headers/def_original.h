...
// Get power from the cat constructed without any info of properties
...
*/
#define EXTRA_DM_BINS  static_cast<int>(2)
// ***********************************************
...
*/
#ifndef _ASSIGN_MASS_LINKED_TO_V_FROM_REF_
#define _ASSIGN_MASS_POST_
#endif
// ***********************************************
#ifdef test_vmax_mass
#define N_VMAX_BINS static_cast<ULONG>(200)
#else
#define N_VMAX_BINS static_cast<int>(50)
#endif

#endif  // end of _USE_VMAX_AS_PRIMARY_OBSERVABLE_
// ***********************************************
// ***********************************************
...
//#undef _USE_TWO_REFS_MOCKS_ASSIGNMENT_
// *************************
/**
...
//#undef _ASSIGN_PROPERTIES_TO_REFERENCE_
#endif
// *************************
/**
...
#undef _ASSIGN_PROPERTIES_TO_NEW_REFERENCE_
#endif
//********************************************************
/**
...
//********************************************************
/**
* @brief Test to see if what one learns from _USE_HYBRID_ASSIGNMENT_NEW_ is useful
 * @details This option uses the method  BiasMT::assign_tracer_mass_new_new()
...
#define pNbins static_cast<ULONG>(120)
#define SIGMA_REC static_cast<real_prec>(0.08)
#define Exclusion_bins static_cast<ULONG>(3) // number of bins away from the diagonal (exclusion zone) aimimng at not swaping there
#define _USE_OMP_re   //* for reconstruction of props
...
*/
#undef _ASSIGN_MASS_LINKED_TO_V_FROM_REF_
// ***********************************************
// ***********************************************
// ***********************************************
// ***********************************************
...
#else
#define TOLERANCE_FACTOR_L0 static_cast<int>(0.95)
...
// ******************************************************************************************
/**
* @brief Compute the bias object to object. Too slow
* @details Called from BiasMT methods. Implemented as a PowerSpectrumF method.
#undef _USE_BIAS_OBJECT_TO_OBJECT_
**/
// ******************************************************************************************
// ******************************************************************************************
...
#define _USE_NP_VEL_
#define _CORRECT_VEL_HALOMASS_  // ADHOC CORRECTION OF THE VELOCITIES AS A FUNCTION OF THE HALO MASSS
