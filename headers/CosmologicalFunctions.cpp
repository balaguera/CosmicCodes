...
real_prec Cosmology::Hubble_function(real_prec redshift){
  return this->s_cosmo_pars.Hubble*sqrt(this->s_cosmo_pars.Om_matter*pow(1.+redshift,3.)+this->s_cosmo_pars.Om_radiation*pow(1.+redshift,4.)+this->s_cosmo_pars.Om_k*pow(1+redshift,2.)+this->s_cosmo_pars.Om_vac*pow(1+redshift,3.*(1.+this->s_cosmo_pars.w_eos)));
}
////////////////////////////////////////////////////////////////////////////
...
real_prec Cosmology::omega_dark_energy(real_prec redshift){
  return this->s_cosmo_pars.Om_vac*pow(1+redshift,3.*(1+this->s_cosmo_pars.w_eos))*pow(Hubble_function(redshift)/this->s_cosmo_pars.Hubble,-2);
}
////////////////////////////////////////////////////////////////////////////
